\chapter{Edge effects in the analysis of morphological characteristics}\thumbforchapter
...
[Insert a (short) description of Python code below., ie don't show only code]
